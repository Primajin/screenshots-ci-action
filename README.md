...
- ref: [https://github.com/puppeteer/puppeteer/blob/main/src/common/DeviceDescriptors.ts](https://github.com/puppeteer/puppeteer/blob/main/docs/api/puppeteer.knowndevices.md)
